...
const examScheduleDelegate = () => delegate('examSchedule', 'exam_schedules', 'exam_schedule');
const examResultDelegate = () => delegate('examResult', 'exam_results', 'exam_result');
const courseExamDelegate = () => delegate('courseExam', 'course_exams', 'course_exam');
